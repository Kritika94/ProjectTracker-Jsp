<%-- 
    Document   : AboutProjectManage
    Created on : 29 Feb, 2020, 11:52:52 PM
    Author     : Kritika
--%>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"></script>
   ...
   document.getElementById("adddev").classList.remove("active");
}
myFunction();
    ...
    <body>
         ...
         <div class="container-fluid" >
              <div style="margin-left:10%; width:50%; color:white; margin-top:1%; "><img src="images/projectTracker.gif"></div>
             <% 
            ...
            JDBCConnectivity.ps = JDBCConnectivity.cn1.prepareStatement("Select emp_id from project_manager where uname=?") ;
